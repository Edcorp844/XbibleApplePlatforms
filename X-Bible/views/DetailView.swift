...
struct DetailView: View {
    ...
    // Received down directly from the parent ContentView hierarchy
    ...
    var body: some View {
        ...
        #else
        // iOS requires a navigation container host for child toolbar/navigation items to display
        NavigationStack {
            contentMatrix
        }
        #endif
    ...
    // MARK: - Layout Switch Core
    
    @ViewBuilder
    private var contentMatrix: some View {
        switch selection {
        ...
        case .audioBible:       AudioBibleView(viewModel: viewModel)
        case .maps:             MapsView()
